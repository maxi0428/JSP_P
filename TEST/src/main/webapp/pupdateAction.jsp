...
<body>
	<%
		...
		if (!userID.equals(prob.getUserID())) {
			...
			if (request.getParameter("probTitle") == null || request.getParameter("probContent") == null
					|| request.getParameter("probTitle") == "" || request.getParameter("probContent") == ""){
					PrintWriter script = response.getWriter();
					script.println("<script>");
					...
					int result = probDAO.update(probID, request.getParameter("probTitle"), request.getParameter("probContent"), request.getParameter("probSt"));
					if (result == -1) {
						PrintWriter script = response.getWriter();
						script.println("<script>");
